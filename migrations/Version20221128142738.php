 ...
 */
final class Version20221128142738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE video (id INT AUTO_INCREMENT NOT NULL, visibility_id INT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, thumnbnail VARCHAR(255) DEFAULT NULL, video_file VARCHAR(255) NOT NULL, description2 LONGTEXT DEFAULT NULL, INDEX IDX_7CC7DA2CB7157780 (visibility_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
